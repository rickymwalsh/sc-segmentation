...
## Get list of training/validation images and their corresponding masks.
...
# Get a list of tuples of relative filepaths (image, mask)
...
model_fname = os.path.join('..','sct_deepseg_lesion_models', 't2_lesion.h5')
